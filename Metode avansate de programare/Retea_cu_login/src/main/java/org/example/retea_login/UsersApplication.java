...
//        Mesaj mesaj = new Mesaj(11L, "ceva");
//        mesaj.addSendTo(9L);
//        try {
...
//        }
//        System.out.println(mesajRepository.findOne(mesaj.getId()));
//        mesajRepository.delete(new Tuple<>(mesaj.getId().getLeft(), 9L));
//        System.out.println(mesajRepository.findOne(mesaj.getId()));
        ...
        usersController.setService(service, null, stage);
